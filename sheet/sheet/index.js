...
async function openProductPage(platform_link) {
    switch (agent_selector.value) {
        ...
        case "ACBuy":
            ...
            break
        case "KakoBuy":
            window.open(getKakoBuyLink(platform_link), "_blank")
            break
    }
}
...
function getKakoBuyLink(platform_link) {
    return "https://www.kakobuy.com/item/details?url=" + encodeURIComponent(platform_link) + "&affcode=" + myAffiliateCodeKakoBuy
}
...
const myAffiliateCodeKakoBuy = "zcat9"